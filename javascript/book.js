...
function validation() {
    ...
    if (isNaN(card_cvv) === false && card_cvv.length === 3 )  {
        valid += 1
    }
    if (valid === 3) {
...
let card__number = document.getElementById("card_number")
let card__holder = document.getElementById("card_holder")
let card__cvv = document.getElementById("cvv")
let month = document.getElementById("months")
let year = document.getElementById("years")

card__number.addEventListener("change", validate)
card__holder.addEventListener("change", validate)
card__cvv.addEventListener("change", validate)
